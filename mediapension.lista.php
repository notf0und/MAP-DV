	...
	<div class="row-fluid">
        <div class="widget-box">
          ...
          <div class="widget-content nopadding">
			<?php
				$sqlQuery = "SELECT MP.idmediapension, H.Titular 'Nome PAX', MP.numeroexterno 'Voucher', S.Nombre 'Servicio', MP.qtdedepax Pax, qtdedecomidas 'Dias', (SELECT COUNT(idmediapension) FROM mediapension_admisiones WHERE idmediapension = MP.idmediapension) 'admisiones' FROM `mediapension` MP";
