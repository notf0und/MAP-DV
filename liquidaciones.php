...
<!--breadcrumbs-->
  <div id="content-header">
	...
	<h1>Liquidaciones - Menu de opções</h1><hr>
  </div>
<!--End-breadcrumbs-->
  ...
  <div class="container-fluid">
    <div class="quick-actions_homepage">
      <ul class="quick-actions">
        <li class="bg_lr span2"> <a href="liquidaciones.mensual.php"> <i class="icon-plus"></i> Liq. Mensual. </a> </li>
        <!--
        ...
        -->
        <li class="bg_lb span2"> <a href="liquidaciones.pendientes.php"> <i class="icon-share-alt"></i> Liq. Pendientes</a> </li>
        <li class="bg_lb span2"> <a href="liquidaciones.cerradas.php"> <i class="icon-share-alt"></i> Liq. Cerradas</a> </li>
      </ul>
    </div>
<!--End-Action boxes-->    
