...
$sql .= "COALESCE(OT.nombre, 'Sem Especificar') Pais, ";
...
$sql .= "LEFT JOIN operadoresturisticos OT  ON MP.idoperadoresturisticos = OT.idoperadoresturisticos ";
...
$sql .= "GROUP BY OT.idoperadoresturisticos; ";
