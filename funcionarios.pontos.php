...
//SELECT
$sql = "SELECT employee_id, CONCAT(P.firstname, ' ', P.lastname) Funcionario, fromhour, TIME(NOW()) hora FROM employee E LEFT JOIN profile P ON E.profile_id = P.profile_id WHERE E.decline IS NULL AND E.idempresa = 2";
$result = resultFromQuery($sql);
