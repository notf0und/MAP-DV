...
$sqlQuery .= "LEFT JOIN (SELECT employee_id, MAX(valid_from) clid FROM clearance WHERE permanent = 1 GROUP BY employee_id) CL ON E.employee_id = CL.employee_id ";
	...
	<div class="row-fluid">
        ...
        <div class="widget-box">
          <div class="widget-title"> <span class="icon"><i class="icon-th"></i></span>
			...
			<?php echo '<div id="no-print">'.$fDeclined.'</div>' ?>
          </div>
