				...
				<div class="widget-content nopadding">
					<form action="posts.php" id="form-wizard" name="form-wizard" class="form-horizontal" method="post">
						...
						<div id="form-wizard-2" class="step">
							...
							<div class="control-group">
								<label class="control-label">Qtde de Noites</label>
								<div class="controls">
									<input id="qtdedenoites" name="qtdedenoites" type="text" id="noites" value="" class="span2"  required="true" />
								</div>
							</div>
						</div>
