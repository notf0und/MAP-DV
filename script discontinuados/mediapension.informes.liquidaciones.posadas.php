			...
			<div class="widget-box">
				...
				<div class="widget-content nopadding">
					...
					<div class="control-group">
						<label class="control-label">Posada</label>
						<div class="controls">
							<?php
          ...
          <div class="widget-content nopadding">
			<?php
				...
				*/
				...
				$sqlQuery .= " WHERE 1 ";
				if ($idagencias!=0){
					$sqlQuery .= " AND MP.idagencias = ".$idagencias;
				}
...
<?php if ($_POST['accion'] == 'reporte'){?>
	<script languaje="javascript"> self.location="mediapension.informes.liquidaciones.posadas.reporte.php"</script>
<?php }?>
