...
$sqlQuery .= "CONCAT(P.lastname, ', ', P.firstname) ";
$sqlQuery .= "FROM employee E ";
$sqlQuery .= "LEFT JOIN profile P ON E.profile_id = P.profile_id ";
$resultado = resultFromQuery($sqlQuery);
$comboemployee = comboFromArray('employee_id', $resultado, $employee_id, '', '', false, 'span4 m-wrap');
...
$resultado = resultFromQuery($sqlQuery);
$combopaymenttype = comboFromArray('paymenttype_id', $resultado, $paymenttype_id, '', '', false, 'span4 m-wrap');
...
$resultado = resultFromQuery($sqlQuery);
$combopaymentmethod = comboFromArray('paymentmethod_id', $resultado, $paymentmethod_id, '', '', false, 'span4 m-wrap');
?>
